...
public class Coordinates {
    ...
    public Coordinates newPosition(Coordinates targetPosition, ArrayList<Person> team) {
    ...
    public boolean containsByPos(Coordinates nextPosition, ArrayList<Person> team) {
